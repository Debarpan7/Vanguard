...
| Vanguard fund-level annual reports (examples) | Financial statements of individual Vanguard funds (net assets, expense ratios, advisory fees paid) — describe the **funds**, not The Vanguard Group, Inc. | e.g. https://fund-docs.vanguard.com/lifestrategy-annual-report.pdf; https://personal1.vanguard.com/funds/ncsr/NCSR103.pdf | ✅ VERIFIED-FROM-URL (URLs exist). Not usable as firm financials; usable only as a bottom-up proxy (see Gaps). |
| Vanguard Investment Stewardship annual reports | Voting and engagement reports, not financial statements | e.g. https://corporate.vanguard.com/content/dam/corp/advocate/investment-stewardship/pdf/policies-and-reports/investment_stewardship_2023_annual_report.pdf | ✅ VERIFIED-FROM-URL. ⚠️ Not read this session (PDF). Not financial data. |
...
| **Fee savings / performance claims** | Press release (Feb 2026), CEO letter (May 2026) | 2025–2026 | ~$600M combined 2025+2026 fee savings; $250M in 2026 (53 funds); 84% of funds beat Lipper peer averages over 10 yrs (275/326, period ended Dec 31, 2025); 86% of active fixed income beat over a decade (CEO letter) vs 88% (press release — different measure). Qualitative and selective; not audited financials. |
