...
- [ ] RoE tree renders per the agreed decomposition
- [ ] Drilldown reaches each driver node across the 5 years
- [ ] Every node shows the published numbers it derives from
- [ ] Browser E2E test asserts the tree nodes render the correct values from a seeded fact base
