...
- [ ] Peer set RoE comparison renders over the 5 years
- [ ] Line-of-business RoE comparison renders against each relevant industry
- [ ] Ownership caveat and line-of-business derivation disclosure are shown
- [ ] Browser E2E test asserts the comparison views render the correct values from a seeded fact base
