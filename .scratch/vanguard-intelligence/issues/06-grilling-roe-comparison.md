...
- Reviewed by two-axis review during ticket 16 implementation (commit `e7117b5`). No blockers on the comparison design decisions; implementation detail lives in `issues/16-task-roe-comparison-views.md`.
